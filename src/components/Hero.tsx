      ...
      <div className="container max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl font-handwritten mb-8 tracking-wide text-fogon-dark">
            Bienvenido al <span className="text-fogon-amber">fogón</span>
          </h1>
          <div className="card-border mb-12 max-w-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a
              href="#producto"
              className="px-6 py-3 bg-fogon-amber hover:bg-fogon-ember transition-colors rounded-md text-fogon-cream font-medium text-lg font-serif"
            >
              Consíguelo Ahora
            </a>
            <a
              href="#como-jugar"
              className="px-6 py-3 bg-transparent border border-fogon-dark text-fogon-dark hover:border-fogon-amber hover:text-fogon-amber transition-colors rounded-md font-medium text-lg font-serif"
            >
              Descubre Cómo Jugar
            </a>
          </div>
