    ...
    <section id="que-lo-hace-especial" className="py-20 relative">
      <div className="container max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-fogon-dark/90 text-lg max-w-3xl mx-auto font-serif">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="card-border group relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-xl font-handwritten mb-3 text-fogon-dark">Preguntas Cuidadosamente Elaboradas</h3>
          ...
          <div className="card-border group relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-xl font-handwritten mb-3 text-fogon-dark">Diseño Inspirado en la Calidez</h3>
              <p className="text-fogon-dark/90 leading-relaxed font-serif">
          ...
          <div className="card-border group relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-xl font-handwritten mb-3 text-fogon-dark">Adaptable a Cualquier Grupo</h3>
              <p className="text-fogon-dark/90 leading-relaxed font-serif">
        ...
        <div className="mt-16 mx-auto max-w-3xl text-center">
          <div className="card-border">
            <p className="text-fogon-amber text-lg font-medium mb-4 font-handwritten">Lo que dicen nuestros jugadores</p>
            <blockquote className="text-fogon-dark/90 text-xl italic mb-4 font-serif">
            ...
            <cite className="text-fogon-dark/70 block font-serif">— María, 34 años</cite>
          </div>
        </div>
      </div>
    </section>
