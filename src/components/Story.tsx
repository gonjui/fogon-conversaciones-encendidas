      ...
      <div className="container max-w-7xl mx-auto px-6">
        <div className="max-w-3xl mx-auto">
          <div className="flex items-center justify-center mb-6">
            <div className="w-12 h-12 rounded-full bg-fogon-red/10 flex items-center justify-center">
              <BookOpen className="h-6 w-6 text-fogon-amber" />
            </div>
          </div>
          <h2 className="text-3xl md:text-4xl font-handwritten mb-8 text-center text-fogon-dark">
            La Historia del <span className="text-fogon-amber">Fogón</span>
          </h2>
          <div className="card-border">
            <div className="prose prose-lg mx-auto text-fogon-dark font-serif">
            ...
            <div className="italic text-center text-fogon-dark/70 my-6 font-handwritten text-xl">
